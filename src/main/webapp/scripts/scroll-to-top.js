...
import { keyboardAccessible } from './miscellaneous.js';
 ...
 */
function createScrollToTopButton(scrollPast, classAttribute = '') {
...
function addBackToTopButton(buttonClassAttribute, elementContainerId, 
  ...
  elementContainer.appendChild(
      createScrollToTopButton(positionFromTop, buttonClassAttribute));
}
