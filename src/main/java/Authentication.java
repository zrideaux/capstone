...
public class Authentication extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (userService.isUserLoggedIn()) {
      ...
      authenticationInfo.put(EMAIL_KEY, email);
      authenticationInfo.put(LOGGED_IN_KEY, loggedIn);
      authenticationInfo.put(LOGOUT_URL_KEY, logoutUrl);
      authenticationInfo.put(IS_ADMIN_KEY, isAdmin);
    } else {
      ...
      authenticationInfo.put(LOGGED_IN_KEY, loggedIn);
      authenticationInfo.put(LOGIN_URL_KEY, loginUrl);
    }
